...
[![npm version](https://badge.fury.io/js/form-validate-js.svg)](https://www.npmjs.com/package/form-validate-js)
...
```javascript
const { js } = require('form-validate-js');
...
```javascript
const { js, batch } = require('form-validate-js');
